INTERFACE zif_app_rule
  ...
  "! <p class="shorttext synchronized" lang="en">Get the token string in upper case</p>
  "!
  ...
  "! Avoid a line break after this token
  "! Could be set for example if the token is a "," to avoid a line break after it
  "!"! <p class="shorttext synchronized" lang="en">Set avoid line break after this token</p>
  "!
  "! @parameter IV_AVOID | <p class="shorttext synchronized" lang="en"></p>
  METHODS set_avoid_lb_after_this_token
    IMPORTING iv_avoid TYPE abap_bool
    RAISING   zcx_app_exception.
ENDINTERFACE.
